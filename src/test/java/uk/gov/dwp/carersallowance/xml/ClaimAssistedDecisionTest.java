...
public class ClaimAssistedDecisionTest {
    ...
    public void checkClaimXmlContainsAssistedDecisionReason() {
        ...
        String decision=xmlBuilder.getNodeValue("/DWPBody/DWPCATransaction/DWPCAClaim/AssistedDecisions/AssistedDecision/Decision");
        assertThat(reason, is("Send DS790/790B COMB to customer."));
        assertThat(decision, is("Send DS790/790B COMB to customer."));
