...
public class FosteringAllowanceController extends AbstractFormController {
    ...
    @Autowired
    public FosteringAllowanceController(final SessionManager sessionManager, final MessageSource messageSource, final TransformationManager transformationManager) {
