...
// TODO the dates are from earlier in the claim
        validateMandatoryField(fieldValues, BEEN_EMPLOYED_SINCE6_MONTHS_BEFORE_CLAIM);
        validateMandatoryField(fieldValues, BEEN_SELF_EMPLOYED_SINCE1_WEEK_BEFORE_CLAIM);
        validateMandatoryField(fieldValues, HAD_OTHER_INCOME_SINCE_CLAIM_DATE);
