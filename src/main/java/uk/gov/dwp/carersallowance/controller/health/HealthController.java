package uk.gov.dwp.carersallowance.controller.health;
...
public class HealthController {
    ...
    public String health() {
        LOGGER.info("STARTED /report/health HealthController.health GET");
        ...
        try {
            ...
            LOGGER.info("ENDED /report/health HealthController.health GET");
        }
        return response;
    }
