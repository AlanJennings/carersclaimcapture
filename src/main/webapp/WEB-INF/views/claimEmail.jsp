        ...
        <div class="main">
            <font face="arial, sans-serif">
                ...
                <div class="section">
                    ...
                    <c:if test="${isSelfEmployed || isEmployedByEmployer || hasStatutorySickPay || hasStatutoryPay}" >
                        <p><t:message code="mail.next.send1" /></p>
                        <ul>
                            <c:if test="${isSelfEmployed}" >
                                <li><t:message code="evidenceText.section4.line5" /></li>
                            </c:if>
                            <c:if test="${isEmployedByEmployer}" >
                                <li><t:message code="evidence.email.employment.mostRecentPayslipBefore" /></li>
                                <li><t:message code="evidence.email.employment.anyPayslipsSince" /></li>
                            </c:if>
                            <c:if test="${pensionStatementsRequired}" >
                                <li><t:message code="evidence.pensionStatements" /></li>
                            </c:if>
                            <c:if test="${hasStatutorySickPay}" >
                                <li><t:message code="evidence.yourIncome.otherPayments.statutorySickPay" /></li>
                            </c:if>
                            <c:if test="${hasStatutoryPay}" >
                                <li><t:message code="evidence.yourIncome.otherPayments.statutoryPay" /></li>
                            </c:if>
                        </ul>
                    ...
                    <c:choose>
                        <c:when test="${isSelfEmployed || isEmployedByEmployer}">
