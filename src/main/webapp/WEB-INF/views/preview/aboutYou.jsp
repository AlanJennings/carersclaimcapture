...
<t:accordion label="/about-you/your-details.pageTitle" openLabel="open-about-you" closeLabel="close-about-you" track="true">
    <t:fieldWithLink id="about_you_claimDate" name="dateOfClaim.label" value="cads:dateOffset(dateOfClaim_day, dateOfClaim_month, dateOfClaim_year, 'dd MMMMMMMMMM, yyyy', '')" displayChangeButton="false" link="${dateOfClaimLink}" />
