            ...
            <t:panel id="employment">
                <c:forEach items="${employment}" var="employmentPosition">
                    ...
                    <li id="employment_${employmentPosition['employment_id']}">
                        ...
                        <div class="actions">
                            <button type="submit" id="changerow_${employmentPosition['employment_id']}" class="actionButton" name="changeSubFormElement" value="${employmentPosition['employment_id']}" aria-label="<t:message code="change.button" />"><t:message code="change" /></button>
                    ...
                    <t:hiddenWarning id="delete_${employmentPosition['employment_id']}" outerClass="prompt breaks-prompt validation-summary" triggerId="deleterow_${employmentPosition['employment_id']}" triggerValue="changerow_${employmentPosition['employment_id']}">
                        ...
                        <button type="submit" class="button row warning" id="yesDeleteButton" name="changeSubFormElement" value="${employmentPosition['employment_id']}" aria-label="<t:message code="yes.delete.label" />" ><t:message code="yes.delete" /></button>
                    </t:hiddenWarning>
                </c:forEach>
            </t:panel>
        </c:if>
