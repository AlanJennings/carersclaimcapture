...
<t:component tagType="group"
    ...
    <fieldset class="question-group">
        ...
        <legend class="form-label-bold " id="${cads:encrypt(pageScope.name)}_label"><t:message code="${pageScope.labelKey}" parentName="${pageScope.name}" element="label" args="${pageScope.labelKeyArgs}" /></legend>
