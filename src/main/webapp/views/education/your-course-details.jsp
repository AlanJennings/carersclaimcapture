...
<t:mainPage pageTitle="${pageTitle}" currentPage="${currentPage}">
    ...
    <t:pageContent errors="${validationErrors}" pageTitle="Education" section="Section 8 of 11" backLink="${previousPage}">
        ...
        <t:hiddenPanel id="educationWrap" triggerId="beenInEducationSinceClaimDate" triggerValue="yes">
            ...
            <t:datefield id="expectedEndDate" 
                         nameDay="expectedEndDate_day" 
                         nameMonth="expectedEndDate_month" 
                         nameYear="expectedEndDate_year" 
                         valueDay="${expectedEndDate_day}" 
                         valueMonth="${expectedEndDate_month}" 
                         valueYear="${expectedEndDate_year}" 
