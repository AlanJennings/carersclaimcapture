...
<article class="column-three-quarters main-content">
    <nav class="back-nav" role="navigation">
        <a id="topBackButton" name="topBackButton" href="/disclaimer/disclaimer">Back</a>
    </nav>
    ...
    <form action="/about-you/your-details" method="POST" role="form">
        ...
        <fieldset class="form-elements" data-journey="carers-allowance:page:about-you">
            <ul>
                <li class="form-group ">
                    ...
                    <input type="text" class="form-control " id="title" name="title" value="Mr" maxLength="20" autocomplete="off">
                </li>
                
                <li class="form-group ">
                    <label id="firstName_questionLabel" class="form-label-bold" for="firstName"> First name </label> 
                    <input type="text" class="form-control " id="firstName" name="firstName" value="Joe" maxLength="17" autocomplete="off">
                </li>

                <li class="form-group ">
                    <label id="middleName_questionLabel" class="form-label-bold" for="middleName"> Middle name(s) </label> 
                    <input type="text" class="form-control " id="middleName" name="middleName" value="" maxLength="17" autocomplete="off">
                </li>

                <li class="form-group ">
                    <label id="surname_questionLabel" class="form-label-bold" for="surname"> Last name </label> 
                    <input type="text" class="form-control " id="surname" name="surname" value="Bloggs" maxLength="35" autocomplete="off">
                </li>
                ...
                <li class="form-group ">
                    ...
                    <input type="text" 
                           ...
                           name="nationalInsuranceNumber.nino" 
                           value="AB123456D" 
                           maxLength="19" 
                           class="ni-number" 
                           autocomplete="off">
        ...
        <nav class="form-steps" role="navigation">
            <ul>
                ...
                <li>
                    <a id="bottomBackButton" name="bottomBackButton" href="/disclaimer/disclaimer">Back</a>
               </li>
            </ul>
        </nav>
    </form>
