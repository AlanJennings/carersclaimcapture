...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <head>
        ...
        <title>Disclaimer - Before you start</title>
    ...
    <body>
        ...
        <div id="global-browser-prompt">
            <p>For a safer, faster, better experience online you should upgrade your browser. 
        ...
        <main class="container" role="main" id="main">
            <div class="carers-allowance clearfix">
                ...
                <div class="grid-row main-grid">
                    ...
                    <jsp:include page="./disclaimer-content.jsp" >
